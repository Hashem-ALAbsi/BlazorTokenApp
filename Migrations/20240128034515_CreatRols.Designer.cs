...
namespace BlazorTokenApp.Migrations
{
    ...
    [Migration("20240128034515_CreatRols")]
    partial class CreatRols
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorTokenApp.Models.ActivityContent", b =>
                {
            ...
            modelBuilder.Entity("BlazorTokenApp.Models.ActivityRegister", b =>
                {
                    b.Property<int>("IDActivity")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorTokenApp.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BlazorTokenApp.Models.TPBooking", b =>
                {
            ...
            modelBuilder.Entity("BlazorTokenApp.Models.TPImage", b =>
                {
            ...
            modelBuilder.Entity("BlazorTokenApp.Models.TypeContent", b =>
                {
                    b.Property<int>("TypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorTokenApp.Models.TypeIctivity", b =>
                {
                    b.Property<int>("TypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorTokenApp.Models.ActivityContent", b =>
                {
                    b.HasOne("BlazorTokenApp.Models.ActivityRegister", "activityRegister")
                        .WithMany()
                        .HasForeignKey("IDActivity")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlazorTokenApp.Models.TypeContent", "type")
                        .WithMany()
            ...
            modelBuilder.Entity("BlazorTokenApp.Models.ActivityRegister", b =>
                {
                    b.HasOne("BlazorTokenApp.Models.TypeIctivity", "type")
                        .WithMany()
                        .HasForeignKey("TypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlazorTokenApp.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("BlazorTokenApp.Models.ApplicationUser", b =>
                {
                    b.OwnsMany("BlazorTokenApp.Models.RefreshToken", "RefreshTokens", b1 =>
                        {
            ...
            modelBuilder.Entity("BlazorTokenApp.Models.TPBooking", b =>
                {
                    b.HasOne("BlazorTokenApp.Models.ActivityContent", "activityContent")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BlazorTokenApp.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
